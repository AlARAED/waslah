...
<body class="common-front @if($currentLang->rtl == 1) rtl @endif" @if($currentLang->rtl == 1) dir="rtl" @endif>
        ...
        <div class="header__content__venor">
            <div class="header__logo">
                <a href="{{url('/')}}" title="{{$setting->title}}">
                    <img width="105" height="22" class="img-fluid logo-front" src="/images/media/waslah.png" alt="logo">
                </a>
            </div>
            ...
            <div class="header__actions__venor">
                ...
                <div class="header__action header__action--signin">
                    <a class="header__action-btn header__action-btn--start-project" href="https://wa.me/{{$setting->phone}}">
 ...
 --}}
    ...
    <div class="hidden"  itemscope="" itemtype="https://schema.org/LocalBusiness">
        ...
        <img src="{{route('home')}}{{$setting->photo ? '/public/images/media/' . $setting->photo->file : '/img/200x200.png'}}" alt="logo" width="120" itemprop="url"></div>
