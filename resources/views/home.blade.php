                        ...
                        <div class="col-md-5">
                         ...
                         <div class="col-md-7">
                            <div class="slider-image">
                               <img width="450" height="450" class="owl-lazy img-fluid slider-img" src="/loading-blog.gif" data-src="{{$slido->photo ? '/images/media/' . $slido->photo->file : '/img/200x200.png'}}" alt="" >
                            </div>
                         </div>
                     </div>
                </div>
